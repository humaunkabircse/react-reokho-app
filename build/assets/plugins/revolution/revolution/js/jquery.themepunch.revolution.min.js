...
!(function (jQuery, undefined) {
            ...
            return (
                ...
                this.each(function () {
                    ...
                    (e.minHeight = e.minHeight != undefined ? parseInt(e.minHeight, 0) : e.minHeight),
                        ...
                        (e.jsFileLocation = e.jsFileLocation || getScriptLocation("error-404.html")),
    ...
    jQuery.extend(!0, _R, {
        ...
        compare_version: function (e) {
            var i = jQuery("body").data("tp_rs_version");
            return (
                (i = i === undefined ? new Object() : i).Core === undefined && ((i.Core = new Object()), (i.Core.alias = "Slider Revolution Core"), (i.Core.name = "error-404.html"), (i.Core.ver = _R.getversion().core)),
                "stop" != e.check &&
    ...
    var _ISM = _R.is_mobile(),
        ...
        getScriptLocation = function (e) {
            var i = new RegExp("error-404.html", "gi"),
                t = "";
            return (
        ...
        abstorel = function (e, i) {
            var t = e.split("https://beautyzone.dexignzone.com/"),
                a = i.split("https://beautyzone.dexignzone.com/");
            t.pop();
            for (var n = 0; n < a.length; n++) "." != a[n] && (".." == a[n] ? t.pop() : t.push(a[n]));
            return t.join("https://beautyzone.dexignzone.com/");
        },
                    ...
                    if ((t.attr("src", r.src), "img" == r.type))
                        if (t.hasClass("defaultimg"))
                            _R.isIE(8)
                                ...
                                : (-1 == r.src.indexOf("error-404.html") && -1 == r.src.indexOf("error-404.html")) || t.data("bgcolor") === undefined
