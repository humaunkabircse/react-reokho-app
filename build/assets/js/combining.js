    ...
    return {
        init: function () {
            jQuery(".box-hover").on("mouseenter", function () {
                    ...
                    if (
                        (jQuery(".scroll")
                            ...
                            .on("click", function (e) {
                                if ((e.preventDefault(), "" !== this.hash)) {
                                    ...
                                    jQuery("body").scrollspy({ target: ".navbar", offset: n + 2 });
                                    var i = r - n;
                                    jQuery("html, body").animate({ scrollTop: i }, 800, function () {});
                                }
                            }),
                        ...
                        jQuery('.navbar-nav-scroll a[href^="#"]').on("click", function (e) {
                            ...
                            i.length > 0 &&
                                jQuery("html, body")
                                    .stop()
                                    .animate({ scrollTop: i.offset().top - r }, 500, "swing", function () {
                                        jQuery(document).on("scroll", t);
                                    });
                        });
                    }
                ...
                $("#lightgallery, .lightgallery").length > 0 && $("#lightgallery, .lightgallery").lightGallery({ selector: ".check-km", loop: !0, download: !1, share: !1, thumbnail: !0, exThumbImage: "data-exthumbimage" }),
                (function () {
                    if ($("#smartwizard").length > 0) {
                        ...
                        $("#smartwizard").smartWizard({
                            ...
                            showStepURLhash: !0,
                            toolbarSettings: { toolbarPosition: "both", toolbarButtonPosition: "end", toolbarExtraButtons: [e, t] },
                        }),
        ...
        load: function () {
            e > 1023 &&
                ...
                jQuery("body").append(
                    '<a href="https://www.facebook.com/Architecturalpoint99/" target="_blank" class="bt-buy-now theme-btn"><i class="ti-facebook"></i><span>Architectural Point</span></a><a href="https://wa.me/+8801727584399" target="_blank" class="bt-support-now theme-btn"><i class="fa fa-whatsapp"></i><span>+8801727-584399</span></a>'
                );
        },
...
jQuery(document).ready(function () {
    ...
    jQuery(".img-carousel").owlCarousel({
        ...
        jQuery(".testimonial-two-dots").owlCarousel({
            ...
            dots: !0,
            navText: ['<i class="ti-angle-left"></i>', '<i class="ti-angle-right"></i>'],
            responsive: { 0: { items: 2 }, 768: { items: 3 }, 991: { items: 4 }, 1200: { items: 6 } },
        }),
        jQuery(".team-carousel").owlCarousel({
            ...
            autoplay: 3e3,
            navText: ['<i class="ti-angle-left"></i>', '<i class="ti-angle-right"></i>'],
            responsive: { 0: { items: 2 }, 768: { items: 4 }, 991: { items: 6 }, 1200: { items: 8 } },
        }),
    ...
    var e = $("#sync1"),
        ...
        i = !0;
    e
        .owlCarousel({ items: 1, slideSpeed: 2e3, nav: !0, autoplay: !1, dots: !1, loop: !0, responsiveRefreshRate: 200, navText: ['<i class="fa fa-chevron-left"></i>', '<i class="fa fa-chevron-right"></i>'] })
        ...
        a
            ...
            .owlCarousel({ items: 4, dots: !1, nav: !1, margin: 5, smartSpeed: 200, slideSpeed: 500, slideBy: 4, responsiveRefreshRate: 100 })
